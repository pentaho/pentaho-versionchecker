...
public class BasicVersionCheckerProvider implements IVersionCheckDataProvider
{
	...
	/**
	 * Returns the application id (code) for this application (the pentaho
	 * platform)
	 */
	...
	/**
	 * Returns the base url for the connection to the pentaho version checking
	 * server. Currently, there is no reason to use anything other than the
	 * default.
	 */
