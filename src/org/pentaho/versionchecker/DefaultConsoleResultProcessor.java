...
/**
 * Default result processor for the VersionCheck process which outputs the
 * results to the console's output (System.out for )
 * @author dkincade
 */
public class DefaultConsoleResultProcessor implements IVersionCheckErrorHandler, IVersionCheckResultHandler {
  /**
   * The print stream that is used for displaying the results. By default, this is 
   * <code>System.out</code>
   */
  private PrintStream out = System.out;

  /**
   * The print stream that is used for displaying the errors. By default, this is 
   ...
   * @throws IllegalArgumentExcpetion indicates the parameter passed is <code>null</code>
   */
